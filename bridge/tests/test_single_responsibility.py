...
def test_key_functions_single_owner():
    ...
    owner_map = {
        "read_cfg": "config.py",
        "apply_downloader_proxy": "adapter.py",
        "format_full": "send.py",
        "format_brief": "send.py",
        "extract_urls": "adapter.py",
        "extract_reply_urls": "adapter.py",
        "ParserLite": "pipeline.py",
        "inject_dynamic_options_static": "config.py",
        "sync_cookies_to_upstream": "adapter.py",
        "ensure_chromium": "commands.py",
        "send_items": "send.py",
        "send_one": "send.py",
