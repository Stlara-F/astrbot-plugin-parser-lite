...
def test_bridge_importable_without_astrbot():
    ...
    _code = (
        ...
        "        del sys.modules[k]\n"
        "mods = ['bridge.config','bridge.adapter','bridge.config','bridge.adapter',\n"
        "        'bridge.pipeline','bridge.send','bridge.render',\n"
        "        'bridge.format','bridge.adapter',\n"
        "        'bridge.fallback','bridge.doctor','bridge.browser']\n"
        "import importlib\n"
        "try:\n"
        "    for m in mods:\n"
