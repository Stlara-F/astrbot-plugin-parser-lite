...
def _write(path: str, content: str):
    ...
    with open(full, "w", encoding="utf-8") as f:
        f.write(content)
    GENERATED_FILES.append(f"src/nonebot_plugin_parser_lite/{path}")
    print(f"  {path}")
...
if "_STANDALONE" in text:
    ...
    GENERATED_FILES.append(f"src/nonebot_plugin_parser_lite/__init__.py")
...
if os.path.exists(rt_path):
    ...
    if "Auto-generated by standalone" not in "\n".join(lines):
        ...
        # Broadest ignore for auto-generated stubs
        full += f'"src/nonebot_plugin_parser_lite/utils/_standalone_fake.py" = ["ALL"]\n'
        # Dynamic ignores for patched files
        for gf in GENERATED_FILES:
            if gf != f"src/nonebot_plugin_parser_lite/utils/_standalone_fake.py":
                full += f'"{gf}" = ["I001"]\n'
