...
if os.path.exists("ruff.toml"):
    lines = open("ruff.toml", encoding="utf-8").read().split("\n")
    if "Auto-generated by standalone" not in "\n".join(lines):
        with open("ruff.toml", "a", encoding="utf-8") as f:
            f.write("\n# Auto-generated by standalone workflow — do not edit\n")
            f.write("[lint.per-file-ignores]\n")
            f.write('"src/nonebot_plugin_parser_lite/__init__.py" = ["I001", "Q000", "F405"]\n')
            f.write('"src/nonebot_plugin_parser_lite/utils/_flags.py" = ["E731", "I001"]\n')
            f.write('"src/nonebot_plugin_parser_lite/utils/env.py" = ["I001"]\n')
            f.write('"src/nonebot_plugin_parser_lite/utils/_standalone_fake.py" = ["ALL"]\n')
