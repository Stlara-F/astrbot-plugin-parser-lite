# Auto-generated standalone stub for nonebot_plugin_alconna.extension
...
current_event = _Stub
get_driver = _Stub
get_message_id = _Stub
get_plugin_config = _Stub
logger = _Stub
on_alconna = _Stub
on_command = _Stub
reply_fetch = _Stub
template_to_pic = _Stub
to_me = _Stub
uniseg = _Stub
